            ...
            <div class={"about-site"}>
                ...
                <div class={"crate-container"}>
                    ...
                    <div class={"content-container"}>
                        <h2>{"Yew"} </h2>
                        <p>{"The front-end of this website is built using Yew, a modern Rust framework for creating multi-threaded web apps with WebAssembly. Yew is inspired by modern JavaScript frameworks such as React and Vue, which use a component-based architecture that allows for the reuse of UI elements, and a lightweight Virtual DOM to improve performance."}</p>
                    </div>
                </div>
                <div class={"crate-container"}>
